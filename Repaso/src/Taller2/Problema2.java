...
/*
En un restaurante se tienen diferentes tipos de menú para ofrecer a los clientes.
Una cuenta por pagar está compuesta por características como: nombre del cliente,
listado de todas las cartas(menú) solicitadas por el cliente, valor a cancelar total,
subtotal, Iva.

Los tipos de menú del restaurante son:
...
Valor del menú
Valor inicial del menú
Valor de la porción de helado
Valor de la porción de pastel
Menú económico
...
Un diagrama exclusivo que involucran las clases de tipo Menú (usar polimorfismo)
...
(nombre del cliente, subtotal, iva, listado de todos los menús, valor a cancelar un total.
*/